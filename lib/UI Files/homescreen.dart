...
class _HomeScreenState extends State<HomeScreen> {
  Image getImage() {
    if (Global.weatherData.getUpcomingPrecipitations().isNotEmpty &&
        Global.weatherData.getUpcomingPrecipitations().first > 25.4) {
      return Image.asset('assets/rainyweather.png');
    } else if (Global.weatherData.getUpcomingWindSpeeds().isNotEmpty &&
        Global.weatherData.getUpcomingWindSpeeds().first > 15) {
      return Image.asset('assets/windyweather.png');
    }

    return Image.asset('assets/sunnyweather.png');
  }
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(
                                  width:
                                      Global.getWidthByPercentage(context, 20),
                                ),
                                Text(
